<?php
$this->pageTitle = 'Admin user details - ' . Yii::app()->name;
...
<div class="widget-box">
    <div class="widget-header">
        <h5>Details Admin User (<?php echo $model->name; ?>)</h5>
                                ...
                                <div class="span3 center">
                                    <span class="profile-picture">
                                        ...
                                        if ((is_file($filePath)) && (file_exists($filePath))) {
                                            echo CHtml::image(Yii::app()->baseUrl . '/uploads/profile_picture/' . $model->profile_picture, 'Profile Picture', array('alt' => $model->name, 'class' => 'span12 thumbnail', 'title' => $model->name, 'style' => ''));
                                        } else {
                                ...
                                <div class="span9">
                                    ...
                                    <div class="profile-user-info">
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <?php echo $model->UserStatus->status; ?>
                                            </div>
                                        </div>
                                        <div class="profile-info-row">
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    ...
                                    $this->widget('bootstrap.widgets.TbGridView', array(
                                        'id' => 'audit-trail-grid',
                                        'dataProvider' => $model_AuditTrail->search_user_only($model->id, 1),
                        ...
                        <div id="PageviewStatistics" class="tab-pane">
                            <div class="row-fluid">
                                <div class="span12">
                                    ...
                                    $this->widget('bootstrap.widgets.TbGridView', array(
                                        'id' => 'visitor-grid',
                                        'dataProvider' => $model_Visitor->search_user_only($model->id, 1),
