            ...
            $this->widget('bootstrap.widgets.TbGridView', array(
                ...
                'columns' => array(
                    array(
                        ...
                        'type' => 'raw',
                        'value' => '$data->id',
                        'htmlOptions' => array('style' => "text-align:center; width:50px;", 'title' => 'ID'),
                    ),
                    'title',
                    'details',
                    array(
                        'header' => 'Access',
                        'type' => 'raw',
                        'value' => 'UserGroup::get_set_access($data->id)',
                        'htmlOptions' => array('style' => "text-align:left;width:100px;", 'title' => 'Set group permission'),
                    ),
                    array(
                        'header' => 'Actions',
