<?php
$this->pageTitle = 'Weblink Categories - ' . Yii::app()->name;
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('weblink-category-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="widget-box">
    <div class="widget-header">
        <h5>Manage Weblink Categories</h5>
            ...
            $this->widget('bootstrap.widgets.TbGridView', array(
                ...
                'columns' => array(
                    array(
                        ...
                        'filter' => CHtml::activeDropDownList($model, 'parent_id', CHtml::listData(WeblinkCategory::model()->findAll(array('condition' => 'parent_id=0', "order" => "title")), 'id', 'title'), array('empty' => 'All')),
