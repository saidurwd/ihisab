...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark">
            <i class="fa fa-tag fa-fw "></i> Tag <span>> 
        ...
        <article class="col-sm-12">
            ...
            <div class="jarviswidget" id="wid-id-0"
                ...
                <header>
                    ...
                    <h2>COMPARISON INCOME vs EXPENSE</h2>
                    <ul class="nav nav-tabs pull-right in" id="myTab">
                        <li class="active"><a data-toggle="tab" href="#s1"><span
                                    class="hidden-mobile hidden-tablet">MONTH</span></a></li>
                        <li><a data-toggle="tab" href="#s2"><span
                                    class="hidden-mobile hidden-tablet">YEAR</span></a></li>
                        <li><a data-toggle="tab" href="#s3"><span
                                    class="hidden-mobile hidden-tablet">TOTAL</span></a></li>								
                    </ul>
                </header>
                <!-- widget div-->
                    ...
                    <div class="widget-body">
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div class="tab-pane fade" id="s2">
                                <div id="comparisonChartYear" style="height: 400px"></div>
                            </div>
                            <!-- end s2 tab pane -->
                            <div class="tab-pane fade" id="s3">
                                <div id="comparisonChartTotal" style="height: 400px"></div>
                            </div>
                            <!-- end s3 tab pane -->
                        </div>
                        <!-- end content -->
    ...
    <div class="row">
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget" id="wid-id-1"
                ...
                <header>
                    <span class="widget-icon"> <i class="fa fa-tags"></i>
                    </span>
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        <?php
//                        print '<pre>';
//                        print_r(Tag::get_parent_child($_REQUEST ['id']));
//                        print '</pre>';
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    ...
                                    'filter' => CHtml::activeTextField($model, 'amount', array(
                                        'class' => 'form-control'
                                    )),
                                    'htmlOptions' => array(
                                ...
                                array(
                                    ...
                                    'buttons' => array(
                                        'update' => array(
                                            ...
                                            'imageUrl' => '',
                                            'options' => array(
                                                'class' => 'btn btn-xs btn-info fa fa-pencil',
                                                'data-toggle' => 'modal',
                                        ...
                                        'delete' => array(
                                            ...
                                            'imageUrl' => '',
                                            'options' => array(
                                                'class' => 'btn btn-xs btn-info fa fa-trash-o'
                                            )
                                        )
                                    )
                                )
...
<script type="text/javascript">
    $(function () {
        $('#comparisonChart').highcharts({
            title: {
                text: 'MONTHLY COMPARISON INCOME vs EXPENSE',
                x: -20 //center
            },
            xAxis: {
        ...
        $('#comparisonChartYear').highcharts({
            title: {
                text: 'YEARLY COMPARISON INCOME vs EXPENSE',
                x: -20 //center
            },
            xAxis: {
                categories: [<?php echo Account::last_twelve_years(); ?>]
            },
            yAxis: {
                title: {
                    text: 'Amount'
            ...
            series: [{
                    name: 'Income',
                    data: [<?php echo Tag::tagIncomeChartYear($_REQUEST['id']); ?>]
                }, {
                    name: 'Expence',
                    data: [<?php echo Tag::tagExpenseChartYear($_REQUEST['id']); ?>]
                }]
        });
        $('#comparisonChartTotal').highcharts({
            chart: {
                type: 'pie',
                options3d: {
                    enabled: true,
            ...
            series: [{
                    name: 'Amount',
                    data: [
                        ['Income', <?php echo Tag::get_income_tag_total($_REQUEST['id']); ?>],
                        ['Expanse', <?php echo Tag::get_expense_tag_total($_REQUEST['id']); ?>]
                    ]
                }]
        });
    });
