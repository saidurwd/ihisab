...
<div class="modal-body">
    <fieldset>
        <div class="form-group">
            ...
            <div class="col-md-4">
                <?php echo $form->textField($model, 'created', array('class' => 'form-control datepicker', 'data-dateformat' => 'yy-mm-dd')); ?>               
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 control-label">
            ...
            <div class="col-md-4">
                <?php echo $form->dropDownList($model, 'tag', CHtml::listData(Tag::model()->findAll(array('condition' => 'user IN(0,' . Yii::app()->user->id . ')', 'order' => 'tag_name')), 'id', 'alias', 'parent'), array('placeholder' => 'Tags', 'multiple' => true, 'class' => 'select2')); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <?php echo $form->dropDownList($model, 'account', CHtml::listData(Account::model()->findAll(array('condition' => 'user=' . Yii::app()->user->id . ' AND status="Active"')), 'id', 'account_name'), array('class' => 'select2')); ?>
