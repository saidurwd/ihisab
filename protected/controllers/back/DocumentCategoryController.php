...
class DocumentCategoryController extends BackEndController {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['DocumentCategory'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success', 'Document category created successfully');
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['DocumentCategory'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success', 'Document category saved successfully');
                $this->redirect(array('view', 'id' => $model->id));
            }
        }
