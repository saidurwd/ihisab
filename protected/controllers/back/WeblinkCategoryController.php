...
class WeblinkCategoryController extends BackEndController {
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['WeblinkCategory'])) {
            $model->attributes = $_POST['WeblinkCategory'];
            $model->modified_time = date('Y-m-d H:i');
    ...
    public function actionIndex() {
        ...
        $dataProvider = new CActiveDataProvider('WeblinkCategory');
    ...
    public function actionAdmin() {
        ...
        $model = new WeblinkCategory('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['WeblinkCategory']))
            $model->attributes = $_GET['WeblinkCategory'];
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'weblink-category-form') {
