...
class Acl extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('group_id, access, controller_type', 'numerical', 'integerOnly' => true),
            array('controller, actions, action_title', 'length', 'max' => 150),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, group_id, controller, actions, action_title, access, controller_type', 'safe', 'on' => 'search'),
        );
    }
